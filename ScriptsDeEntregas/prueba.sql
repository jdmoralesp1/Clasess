...
(
    SELECT    
        ROW_NUMBER() OVER (ORDER BY "ASDK_ITEM_DW_LAST"."id" ASC) AS "ID",
        "ASDK_ITEM_DW_LAST"."id_by_project" AS "Nro. Ticket",
...
AS TEMP
WHERE TEMP.ID BETWEEN @offset + 1 and @offset + @pageSize