...
public class Persona {
    //Protected hace que yo pueda acceder desde las clases que heredan de esta clase
    ...
    //Genero estos metodos usando insert code
    
    //crea un numero distinto y unico de cada objeto
    @Override
    public int hashCode() {
        int hash = 7;
